...
export const ACCEL = 24;               // trackball acceleration at full deflection (tiles/s^2)
export const FRICTION = 2.0;           // 1/s exponential damping when grounded
export const MAX_SPEED = 16;           // tiles/s
export const SLOPE_K = 1.9;            // tiles/s^2 per (px of drop per tile)
export const GRAVITY = 420;            // px/s^2 while airborne
export const STEP_UP = 3;              // px the marble can climb without it being a wall
export const DROP_SNAP = 4;            // px drop that is just followed (no airtime)
export const WALL_MAX = 56;            // px: surfaces higher than this above the marble are overpasses
