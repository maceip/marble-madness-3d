...
// goal corridor (dark shaded, with the GOAL sign) runs down-LEFT from the chute lip to the goal. Open ramp, NO
// rails — the reference practice race is all open switchback ramps you can fall off (1plongplay.mov). Continuous
// and wide enough that a well-steered marble stays on it to the GOAL sign.
